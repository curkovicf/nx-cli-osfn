...
class ProjectsRepositoryImpl {
    openConfigFiles(workspacePath) {
        return __awaiter(this, void 0, void 0, function* () {
            this.workspacePath = os_utils_namespace_1.OsUtils.parsePath(workspacePath);
            try {
    ...
    getProjectNameFromConfigFile(projects, projectPath) {
        ...
        Object.entries(projects).forEach(([key, value]) => {
            ...
            console.log('Testara ', os_utils_namespace_1.OsUtils.parsePath(projectPath).replace((_b = this.workspacePath) !== null && _b !== void 0 ? _b : '', ''));
